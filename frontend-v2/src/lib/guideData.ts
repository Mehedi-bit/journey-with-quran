      ...
      missionContent: {
        ...
        guidelines: {
          ...
          formatList: [
              ...
              "সংক্ষিপ্ত কুরআনের আয়াত বা উদ্ধৃতি পোস্টের সাথে ভিজুয়ালি দেখানোর করার জন্য 'Verse' ট্যাব ব্যবহার করুন।"
          ],
          ...
          topicsList: [
            ...
            "কুরআনের কোন আয়াত কিভাবে আমাদের জীবনে প্রযোজ্য।",
            "আল্লাহর সুন্দরতম নামসমূহের উপর চিন্তাভাবনা (আল-আসমা উল হুসনা)"
          ],
        },
        welcomeTitle: "আমাদের কমিউনিটিতে স্বাগতম",
        welcomeQuote:
          "আমার পক্ষ থেকে একটি মাত্র আয়াত হলেও তা (মানুষের নিকট) পৌছে দাও। তোমাদের মধ্যে সেই উত্তম যে কুরআন শেখে এবং অন্যদের শেখায়।",
        welcomeQuoteAuthor: "— আল্লাহর রাসূল (সাল্লাল্লাহু আলাইহি ওয়া সাল্লাম)",
        welcomeContent: {
          para1:
